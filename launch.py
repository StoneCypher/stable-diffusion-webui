...
torch_command = os.environ.get('TORCH_COMMAND', "python3 -m pip install -r torch==1.12.1+cu113 torchvision==0.13.1+cu113 --extra-index-url https://download.pytorch.org/whl/cu113")
